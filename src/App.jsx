      ...
      <div className="w-72 bg-gray-900/50 backdrop-blur-xl border-r border-gray-700/50 flex flex-col shadow-2xl">
        ...
        <div className="p-6 border-b border-gray-700/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">工具集</h1>
        ...
        <div className="p-4 border-t border-gray-700/50">
          <div className="text-xs text-gray-500 text-center">
            <p>共 {toolsData.categories.length} 个分类</p>
            <p className="mt-1">{toolsData.categories.reduce((acc, cat) => acc + cat.tools.length, 0)} 个工具</p>
          </div>
        </div>
      </div>
        ...
        {selectedCategory ? (
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-400 ml-13">该分类下共有 {selectedCategory.tools.length} 个工具</p>
            </div>
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-400 mb-2">欢迎使用工具集</h3>
              <p className="text-gray-500">请从左侧选择一个分类开始使用</p>
            </div>
          </div>
        )}
      </div>
